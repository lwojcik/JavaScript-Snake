...
SNAKE.Snake = SNAKE.Snake || (function() {
    ...
    */
    return function(config) {
        ...
        function calculateMovementDirection(xUp, yUp) {
            ...
            if (Math.abs(xDiff) > Math.abs(yDiff) ) {
                if ( xDiff > 0 ) {
                    /* left swipe */ 
                    me.handleArrowKeys(37);
                } else {
                    /* right swipe */
                    me.handleArrowKeys(39);
                }
            } else {
                if ( yDiff > 0 ) {
                    /* up swipe */
                    me.handleArrowKeys(38);
                } else { 
                    /* down swipe */
                    me.handleArrowKeys(40);
                }
            }
            xDown = null;
            yDown = null;
        ...
        */
        ...
        // Ain't nobody got time for doc comments, sorry :(
        ...
        me.handleTouchmove = function(evt) {
            ...
            calculateMovementDirection(xUp, yUp);
        };
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            tmpElm.className = "snake-dialog snake-welcome-dialog";

            var welcomeTxt = document.createElement("p");

            welcomeTxt.innerHTML = "Use arrow keys or swipes to play the game.";
        ...
        function createGameEndElement(message, elmId, elmClassName) {
            ...
            var gameEndTxt = document.createElement("p");
            gameEndTxt.innerHTML = message;
        ...
        function createTryAgainElement() {
            return createGameEndElement("You died!", "sbTryAgain", "snake-dialog snake-try-again-dialog");
        }

        function createWinElement() {
            return createGameEndElement("You won!", "sbWin", "snake-dialog snake-win-dialog");
        }
        ...
        function addTouchListeners() {
            SNAKE.addEventListener(elmContainer, "touchstart", myTouchstartListener, { passive: true });
            SNAKE.addEventListener(elmContainer, "touchmove", myTouchmoveListener, { passive: true });
        }
        ...
        function removeTouchListeners() {
            SNAKE.removeEventListener(elmContainer, "touchstart", myTouchstartListener, { passive: true });
            SNAKE.removeEventListener(elmContainer, "touchmove", myTouchmoveListener, { passive: true });
        }
        ...
        */
        me.setupPlayingField = function () {
            ...
            myTouchmoveListener = function(evt) {
                if (me.getBoardState() === 1) {
                    removeTouchListeners();

                    myTouchmoveListener = function(evt) {
                        if(!evt) var evt = window.event;
                        mySnake.handleTouchmove(evt);
                    }
                    myTouchstartListener = function(evt) {
                        if(!evt) var evt = window.event;
                        mySnake.handleTouchstart(evt);
                    }
